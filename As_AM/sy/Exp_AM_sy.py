...
chunk_idx_path = '/data/kwang3/work8/As_benchmark/As_index/sy/'
...
for i in range (len(s1_datasets)):
    ...
    for seeds in range(15):  
        ...
        for idx in range (1, len(s1_chunk_size)):
            ...
            s1_GB_chunk_f1 = f1_score(s1_y_test, s1_GB_y_pred, average = 'macro')
            ...
            s2_GB_chunk_f1 = f1_score(s2_y_test, s2_GB_y_pred, average = 'macro')
            ...
            s3_GB_chunk_f1 = f1_score(s3_y_test, s3_GB_y_pred, average = 'macro')
            ...
            s1_meta_chunk_f1 = f1_score(s1_y_test, s1_meta_pred, average = 'macro')
            s2_meta_chunk_f1 = f1_score(s2_y_test, s2_meta_pred, average = 'macro')
            s3_meta_chunk_f1 = f1_score(s3_y_test, s3_meta_pred, average = 'macro')
